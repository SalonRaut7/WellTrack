...
//         [HttpGet]
//         public async Task<IActionResult> GetAll() => Ok(await _context.HabitEntries.ToListAsync());
...
//         [HttpPost]
//         public async Task<IActionResult> Create(HabitEntry habit)
//         {
...
//         [HttpPut("{id}")]
//         public async Task<IActionResult> Update(int id, HabitEntry habit)
//         {
