...
//         [HttpGet]
//         public async Task<IActionResult> GetAll() => Ok(await _context.HydrationEntries.ToListAsync());
...
//         [HttpPost]
//         public async Task<IActionResult> Create(HydrationEntry entry)
//         {
...
//         [HttpPut("{id}")]
//         public async Task<IActionResult> Update(int id, HydrationEntry entry)
//         {
