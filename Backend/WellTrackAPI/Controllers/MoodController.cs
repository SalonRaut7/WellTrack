...
namespace WellTrackAPI.Controllers
{
    ...
    public class MoodController : ControllerBase
    {
        ...
        public MoodController(IMoodService service) => _service = service;
        ...
        [HttpPost] public async Task<IActionResult> Create(MoodDTO dto) => Ok(await _service.CreateAsync(dto, UserId));
        [HttpPut("{id}")] public async Task<IActionResult> Update(int id, MoodDTO dto) => Ok(await _service.UpdateAsync(id, dto, UserId));
