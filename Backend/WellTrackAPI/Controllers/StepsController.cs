...
namespace WellTrackAPI.Controllers
{
    ...
    public class StepsController : ControllerBase
    {
        ...
        public StepsController(IStepService service) => _service = service;
        ...
        [HttpPost] public async Task<IActionResult> Create(StepDTO dto) => Ok(await _service.CreateAsync(dto, UserId));
        [HttpPut("{id}")] public async Task<IActionResult> Update(int id, StepDTO dto) => Ok(await _service.UpdateAsync(id, dto, UserId));
