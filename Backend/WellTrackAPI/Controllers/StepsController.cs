...
//         [HttpGet]
//         public async Task<IActionResult> GetAll() => Ok(await _context.StepsEntries.ToListAsync());
...
//         [HttpPost]
//         public async Task<IActionResult> Create(StepsEntry entry)
//         {
...
//         [HttpPut("{id}")]
//         public async Task<IActionResult> Update(int id, StepsEntry entry)
//         {
